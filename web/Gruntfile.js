...
module.exports = function (grunt) {
	...
	// 构建任务
	grunt.registerTask('b', ['clean:dev', 'copy:build', 'less:compileCore', 'less:compileTheme', 'nunjucks', 'concat:js']);
	// 发布任务
	grunt.registerTask('r', ['clean:release', 'cssmin', 'uglify', 'imagemin', 'copy:release', 'replace:htmlRelease', 'zip:release']);
